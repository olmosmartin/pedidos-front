                            ...
                            {buscador.pedidos.length >= 1 && !buscador.error ?
                                ...
                                <div className="">
                                    {buscador.pedidos[0]?.map((pedido, i) => (
                                        pedido.estado!=='PREPARANDO'&&pedido.estado!=='PENDIENTE'&&<PedidoRow key={i} idCliente={idCliente} negocioId={pedido.negocio} id={pedido._id} productos={pedido.productos} estado={pedido.estado} total={pedido.total} fecha={pedido.fecha}/>
                                    ))
                                    }
