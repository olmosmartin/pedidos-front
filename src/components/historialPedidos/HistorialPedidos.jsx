                            ...
                            {buscador.pedidos.length >= 1 && !buscador.error ?
                                ...
                                <div className="">
                                    {buscador.pedidos[0]?.map((pedido, i) => (
                                        pedido.estado==='FINALIZADO'&&<PedidoRow key={i} idCliente={idCliente} puntuacion={pedido?.review?.puntuacion} negocioId={pedido.negocio} id={pedido._id} productos={pedido.productos} estado={pedido.estado} total={pedido.total} fecha={pedido.createdAt}/>
                                    ))
                                    }
